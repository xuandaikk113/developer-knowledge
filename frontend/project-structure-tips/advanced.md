# React Advanced project structure
## assets
Nơi chứa các file như svg, ảnh, ...
## components
Nơi chứa các global components dùng chung cho nhiều pages, có thể bao gồm thư mục ui, thư mục form, ...
## context
...
----
Có thêm các thư mục so với intermediate:
## layouts
- Hearder
- Footer
- Sidebar
## services
Các service bên thứ 3 (api call)
## features
- authentication
  - components
  - hooks
